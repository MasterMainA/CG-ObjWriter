...
public class ObjReader {
	...
	public static Vector3f parseVertex(final ArrayList<String> wordsInLineWithoutToken, int lineInd) {
		try {
			if (wordsInLineWithoutToken.size() > 3) {
				throw new ObjReaderException("Too many vertex arguments. Expected 3, got " + wordsInLineWithoutToken.size(), lineInd);
			}
	...
	protected static Vector3f parseNormal(final ArrayList<String> wordsInLineWithoutToken, int lineInd) {
		try {
			if (wordsInLineWithoutToken.size() > 3) {
				throw new ObjReaderException("Too many normal arguments. Expected 3, got " + wordsInLineWithoutToken.size(), lineInd);
			}
